// Server-side QRIS utility functions
// Located at /lib/server/libQris/crc.js
// Provides CRC calculation and QRIS data parsing functions
function pad(d) {
...
function dataQris(str) {
  ...
  let merchantName = get_between(str, "ID59", "60")
    .substring(2)
    .trim()
    .toUpperCase();
