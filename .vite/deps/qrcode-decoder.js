        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 6:
              return [3, 7];
            case 7:
              if (!stream) return [3, 9];
              videoElem.srcObject = stream;
              this.videoElem = videoElem;
              this.stream = stream;
              return [4, this.decodeFromVideo(videoElem, opts)];
            case 8:
              code = _a.sent();
              return [2, code];
            case 9:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              _a.trys.push([1, 3, , 4]);
              this.videoElem = videoElem;
              return [4, this._captureToCanvas(videoElem, opts)];
            case 2:
              code = _a.sent();
              return [2, code];
            case 3:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              imgDom = null;
              opts = __assign(__assign({}, this.defaultOption), options);
              if (!(typeof img === "string")) return [3, 2];
...
qrcode-decoder/dist/index.esm.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=qrcode-decoder.js.map
